<x-admin.page-toolbar>
    ...
    <a href="{{ route('admin.subsubcategories') }}" class="btn btn-primary">Sub-subcategories</a>
    ...
    <a href="{{ route('admin.subsubcategories.show') }}" class="btn btn-secondary btn-outline">Add Sub-subcategory</a>
